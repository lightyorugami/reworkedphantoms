...
public class PhantomSpawnHandler {
        ...
        if (
            ...
            for (ServerPlayerEntity player : world.getPlayers()) {
                ...
                if (
                    ...
                    hasAcquireHardware(player, world) &&
    ...
    private static boolean hasAcquireHardware(ServerPlayerEntity player, ServerWorld world) {
        AdvancementEntry adv = world.getServer().getAdvancementLoader()
